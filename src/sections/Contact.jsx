      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          <div className="w-full bg-[#1a1a1a] rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10 items-start">
              ...
              >
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#A33614] text-[#F6F1EA] font-poppins font-semibold text-[14px] py-3.5 rounded-lg hover:bg-[#8B3116] hover:shadow-lg hover:shadow-[#A33614]/20 transition-all duration-300 cursor-pointer"
                  >
                    Send Message
                  </button>
                </form>
            ...
            {/* Footer */}
            <footer className="mt-14 sm:mt-16 md:mt-20 pt-6 sm:pt-8 border-t border-[#F6F1EA]/10 text-center">
